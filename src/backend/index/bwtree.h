...
#define ROOT_PID 1 // root pid should be 1
    ...
    protected:
      BWNormalNode(size_type s, size_type c, bool i, KeyType low, KeyType high, PID l, PID r): BWNode(s, c, i), low_key_(low), high_key_(high), left(l), right(r) {}
    ...
    public:
      BWInnerNode(size_type s, size_type c, bool i, KeyType low, KeyType high, PID l, PID r, std::vector<KeyType> &ks, const std::vector<PID> &child):
    ...
    public:
      BWLeafNode(size_type s, size_type c, bool i, KeyType low, KeyType high, PID l, PID r, std::vector<KeyType> &ks, const std::vector<ValueType> &vs):
...
// Add your declarations here
    ...
    protected:
      BWDeltaNode(size_type slot_usage, size_type chain_length, BWNode *n): BWNode(slot_usage, chain_length), next(n) {}
      const BWNode *next;
    ...
    public:
      BWSplitEntryNode(size_type slot_usage, size_type chain_length, BWNode *next, KeyType low, KeyType high, PID t):
...
//    }
      ...
      void InsertSplitEntry(__attribute__((unused)) const std::vector<PID> &parent, int level,
...
//    }
      ...
      bool Split(__attribute__((unused)) PID cur, __attribute__((unused)) BWNode *node_ptr,
                 __attribute__((unused)) KeyType &split_key) {
